...
import 'package:login_at/Aadhaar/scan_all.dart';
            ...
            if (result is List<ScanResult>) {
              ...
              for (var data in result) {
                if (data.cleanedText.contains('Address:')) {
                  ...
                  if (RegExp(r'\d{6}').hasMatch(data.cleanedText)) {
                    extractedAddress += ' ' + data.cleanedText;
                    break;
                  } else {
                    // Continue collecting the address
                    extractedAddress += ' ' + data.cleanedText;
                  }
                }
              }
